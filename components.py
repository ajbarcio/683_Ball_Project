...
class Batteries:
    def __init__(self, motors):
        ...
        self.mass = batteryMass*self.number
...
class Motors:
    def __init__(self, torque, reduction, mass, radius, length, name="motors"):
...
neo2ft   = Motors(3.6*0.74*2,  21.5, 2*.98,   1/12.0, 1, name="2ft style")
gen1_6ft = Motors(6.03*0.74*2, 21,   2*5*2.2, 4/12.0, 1, name="6ft style")
